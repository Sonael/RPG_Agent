...
function getImportPrompt(theme) {
  ...
  // A fantasia e o dark fantasy têm o mundo que reage: renome, facções,
  // títulos, laços dos companheiros, lendas, bestiário e mudanças nos lugares.
  const mundo = theme === 'fantasia' || theme === 'dark_fantasy';
  const themeFocus = {
  ...
  if (mundo) {
    prompt += `,\n      "lealdade": <só nos companheiros do grupo: inteiro de -100 (à beira de partir) a 100 (até o fim) — se ele fica quando custar caro>,\n      "objetivo": "<só nos companheiros: o que ele quer da vida>",\n      "arco": {"titulo": "<a história pessoal dele: redenção, vingança, uma dívida>", "estado": "<em curso|cumprido|falhou|abandonado>", "passos": [{"texto": "<o que já aconteceu no arco>", "cap": <capítulo>}]}`;
  }
  ...
  if (mundo) {
    prompt += `,\n  "renome": {"valor": <0 a 100: o quanto o grupo é conhecido — 0 desconhecidos, 50 famosos no reino, 100 lendários>},\n  "faccoes": [\n    {"nome": "<reino, guilda, ordem, cidade, culto...>", "tipo": "<reino|guilda|ordem|cidade|culto|casa nobre|...>", "descricao": "<uma frase>", "reputacao": <-100 inimigos declarados a 100 heróis da causa>, "conhecida": <false se o grupo ainda não sabe que ela existe>}\n  ],\n  "titulos": [\n    {"titulo": "<como o mundo passou a chamar alguém>", "quem": "<nome, ou 'o grupo'>", "motivo": "<o feito>", "efeito": "<o que o título muda>"}\n  ],\n  "lendas": [\n    {"titulo": "<a lenda, profecia ou artefato>", "tipo": "<lenda|profecia|artefato perdido|mistério|ruína>", "verdade": "<o que ela é de fato, se já se sabe ou se a história deixou claro>", "fragmentos": [{"texto": "<o que o grupo ouviu, leu ou viu>", "fonte": "<de quem ou de onde>"}], "desfecho": "<só se a história já resolveu>"}\n  ],\n  "bestiario": [\n    {"nome": "<criatura>", "tipo": "<fera|morto-vivo|dragão|...>", "descricao": "<como ela é>", "fatos": ["<o que o grupo sabe dela>"], "fraquezas": ["<fraquezas descobertas>"], "encontros": <quantas vezes a encontraram>, "derrotadas": <quantas venceram>}\n  ]`;
  }
